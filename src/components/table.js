                ...
                {row.cells.map((cell, index) => {
                    if (cell.column.Header === 'select') {
                        return (
                          ...
                          {cell.render('Cell')}
                          <input type='checkbox' className='checkbox-cell' data-id={cell.row.original._id} onChange={(e)=>SelectHandler(e)} />
                        </td>
                        )
                      } 
                      if (index === columns.length - 1) {
                        return (
                          <td {...cell.getCellProps()}>
                          {cell.render('Cell')}
                          <button type="button" className="btn btn-primary" data-id={row.values._id} >
                            Open</button>
                        </td>
                        )
                      }
...
export function TableRenderer(headers, data) {
